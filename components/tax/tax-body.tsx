      ...
      <div className="w-[90%] mx-auto">
        ...
        <div className="space-y-8 py-3">
          ...
          <div>
            ...
            <h4 className="font-bold text-neutral-400">
              Effective Date:{" "}
              <span className="text-white"> 17 August 2023</span>
            </h4>
          </div>
          ...
          <div>
            ...
            <p>
              Further information on the risks associated with using the VSA
              Exchange Services is set out in our Risk Warning, which may be
              updated from time to time. You should read the Risk Warning
              carefully, however it does not explain all of the risks that may
          ...
          <div>
            ...
            <p>
              ...
              We are not responsible for the decisions you make to buy, earn,
              sell or hold Digital Assets based on the information provided by
              us, including any losses you incur arising from those decisions.
            </p>
          </div>
          <hr />
          <div>
            ...
            <p className="leading-loose">
              ...
              anything. Where any Local Terms apply to your use of the VSA
              Exchange Services, such Local Terms will take precedence over
              these Terms.
            </p>

            <div className="leading-loose">
              1.3. Additional documents. These Terms refer to a number of
              additional documents which also apply to your use of the VSA
              Exchange Services. This includes: a. Our Privacy Notice, which
              sets out the terms on which we process any personal data we
              collect about you, or that you provide to us. By using the VSA
              Exchange Services, you understand and agree to such processing and
              you promise that all data provided by you is accurate and up to
              date. b. Our Risk Warning, which sets out important information on
          ...
          <hr />
          <div>
            <h4 className="font-bold">2. Eligibility</h4>
            ...
            <div className="leading-loose">
              ...
              behalf, you must be duly authorised to act on behalf of and bind
              ...
              without telling you in advance. This may include where: a. we are
              making the change as a result of legal and/or regulatory changes;
              b. the changes being made are in your interest; and/or c. there is
              any other valid reason which means there is no time to give you
              notice. Where we are unable to give you advance notice, we will
              let you know of the change as soon as possible after it is made.
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="leading-loose">
              ...
              <div>
                ...
                control. As a result, trading and withdrawals will be
                temporarily suspended until you make new deposits of certain
                amounts into your account to take off risk control.
              </div>
            </div>
          </div>
          <div>
            <h4 className="font-bold"> 5. Chat Service</h4>
            <div className="leading-loose">
              <div>
                ...
                Applicable Law. When engaging with us through use of the Chat
                Service, you authorise us to monitor and save your chats.
              </div>
              <div>
                5.2. Important information. The Chat Service is provided as a
                convenience, often to facilitate your understanding of the VSA
                Exchange Services. Our Chat Service will make reasonable efforts
              ...
              <div>
                5.3. User Chats. In addition, we may make available to you chats
                that allow you to interact directly with other users of the
                Platform (“User Chat”).
              </div>
              <div>
                5.4. Prohibited actions. You must not use the Chat Service or
                any User Chat to send any abusive, defamatory, dishonest, or
                obscene message or any messages intended to manipulate a market
          ...
          <div>
            <h4 className="font-bold">6. Fees</h4>
            <div className="leading-loose">
              <div>
              ...
              <div>
                ...
                interest, charges and other sums that you owe from your VSA
                Exchange Account under these Terms or any Product Terms in
                accordance with the method of calculation set out on our Fee
                Structure page. If you owe us an amount in one Digital Asset and
                do not have sufficient assets in that Digital Asset, we may
                deduct the sums owed in another Digital Asset to effect payment
                (in which case we will convert the Digital Asset you hold into
                the Digital Asset in which the sums owed to us are denominated
                ...
                may determine, acting in a commercially reasonable manner.
              </div>

              <div>
                6.2. Amending our fees. We may adjust our fees from time to time
                in accordance with clause ‎18.3 of these Terms.
              </div>
            </div>
          </div>
          <div>
            ...
            <div className="leading-loose">
              ...
              <div>
                ...
                consider necessary to verify your identity, and that of any
                Permitted Users, or protect you and/or us against fraud, money
                laundering, terrorist financing or other financial crime, and to
                take any action we deem necessary based on the results of such
                inquiries. When we carry out inquiries, you acknowledge and
                understand that your personal data , and that of any Permitted
                Users, may be disclosed to identity verification, compliance
                data recordation, credit reference, fraud prevention, or
                financial crime agencies and that these agencies may respond to
                our inquiries in full. You can review our Privacy Notice to have
                more information about how we process your personal data. 7.4.
                Enhanced due diligence. We may also require you to comply with
            ...
            <div>
              <div className="leading-loose">
                <h4 className="font-bold">8. Information requests</h4>
                <div>
                  8.1. When we may request information. We may require
                  information from you at any time for the purposes of complying
                  with any Applicable Law, identity verification requirements,
                  or in connection with the detection of money laundering,
                ...
                <div>
                  8.3. If you fail to provide any requested information. You
            ...
            <div>
              <div className="leading-loose">
                ...
                <div>
                  ...
                  subject to such additional terms as we communicate to you.
                </div>
            ...
            <div>
              <div className="leading-loose">
                ...
                <div>
                  10.1. Your Account History. You will be able to access your
                  Account History on the Platform. You must review your Account
                  History carefully and let us know if you see any entries or
                  Transactions that you do not recognise or you think are
                  incorrect within fourteen (14) calendar days of the date that
